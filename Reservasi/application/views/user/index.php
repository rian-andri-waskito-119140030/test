...
<head>
    ...
    <link rel="icon" href="<?=base_url()?>/images/logo2.png">
    <!-- Modernizr JS -->
    ...
    <style type="text/css">
        .header-section{
          background: url('<?= base_url("assets/images/futsal1.png");?>')no-repeat scroll center center;
                            ...
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="logo mt-15">
                                        <a href="index.html"><img src="<?=base_url()?>/images/logo2.png" alt=""></a>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-7">
                            <div class="welcome-text">
                                ...
                                <h2>
                                <span>SELAMAT DATANG DI</span> <span class="coloring">Kusuma Futsal</span>
                                </h2>
                                <p class="welcome-desc">Kami menyediakan lapangan yang berkualitas <br>Sehingga pelanggan merasa puas bermain di sini</p>
                                <div class="explore">
                                    <a href="#">PENASARAN ?</a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title mb-80">
                            <h2>Tentang <span>Pengembangan Web</span></h2>
                            <p>Aplikasi ini dirancang untuk memenuhi tugas besar pemrograman web lanjut</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="about-chondo">
                            <div class="about-member">
                                <img src="<?=base_url()?>/assets/images/user2.png" alt="">
                                <h3>Kelompok </h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title mb-75">
                            <h2>Jenis <span>Lapangan</span></h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        <p>Copyright© Created by <a href="https://freethemescloud.com/"> M Iqbal Ibrahim</a></p>
                    </div>
                </div>
            </div>
        </div>
